...
public class VariableDeclarationIntegerTest {
	
	@Test
	public void VariableDeclarationIntegerTest() throws RecognitionException{
		CharStream cs = new ANTLRStringStream("a = 2;");
