...
public class TLLexer extends Lexer {
    ...
    public final void mPrintln() throws RecognitionException {
        try {
            ...
            // src/grammar/TL.g:191:10: ( 'println' )
            // src/grammar/TL.g:191:12: 'println'
            {
            match("println"); 
    ...
    public final void mPrint() throws RecognitionException {
        try {
            int _type = Print;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:192:10: ( 'print' )
            // src/grammar/TL.g:192:12: 'print'
            {
            match("print"); 
    ...
    public final void mAssert() throws RecognitionException {
        try {
            int _type = Assert;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:193:10: ( 'assert' )
            // src/grammar/TL.g:193:12: 'assert'
            {
            match("assert"); 
    ...
    public final void mSize() throws RecognitionException {
        try {
            int _type = Size;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:194:10: ( 'size' )
            // src/grammar/TL.g:194:12: 'size'
            {
            match("size"); 
    ...
    public final void mDef() throws RecognitionException {
        try {
            int _type = Def;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:195:10: ( 'def' )
            // src/grammar/TL.g:195:12: 'def'
            {
            match("def"); 
    ...
    public final void mIf() throws RecognitionException {
        try {
            int _type = If;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:196:10: ( 'if' )
            // src/grammar/TL.g:196:12: 'if'
            {
            match("if"); 
    ...
    public final void mElse() throws RecognitionException {
        try {
            int _type = Else;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:197:10: ( 'else' )
            // src/grammar/TL.g:197:12: 'else'
            {
            match("else"); 
    ...
    public final void mReturn() throws RecognitionException {
        try {
            int _type = Return;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:198:10: ( 'return' )
            // src/grammar/TL.g:198:12: 'return'
            {
            match("return"); 
    ...
    public final void mFor() throws RecognitionException {
        try {
            int _type = For;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:199:10: ( 'for' )
            // src/grammar/TL.g:199:12: 'for'
            {
            match("for"); 
    ...
    public final void mWhile() throws RecognitionException {
        try {
            int _type = While;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:200:10: ( 'while' )
            // src/grammar/TL.g:200:12: 'while'
            {
            match("while"); 
    ...
    public final void mTo() throws RecognitionException {
        try {
            int _type = To;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:201:10: ( 'to' )
            // src/grammar/TL.g:201:12: 'to'
            {
            match("to"); 
    ...
    public final void mDo() throws RecognitionException {
        try {
            int _type = Do;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:202:10: ( 'do' )
            // src/grammar/TL.g:202:12: 'do'
            {
            match("do"); 
    ...
    public final void mEnd() throws RecognitionException {
        try {
            int _type = End;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:203:10: ( 'end' )
            // src/grammar/TL.g:203:12: 'end'
            {
            match("end"); 
    ...
    public final void mIn() throws RecognitionException {
        try {
            int _type = In;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:204:10: ( 'in' )
            // src/grammar/TL.g:204:12: 'in'
            {
            match("in"); 
    ...
    public final void mNull() throws RecognitionException {
        try {
            int _type = Null;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:205:10: ( 'null' )
            // src/grammar/TL.g:205:12: 'null'
            {
            match("null"); 
    ...
    public final void mBool() throws RecognitionException {
        try {
            int _type = Bool;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:235:3: ( 'true' | 'false' )
            int alt1=2;
    ...
    public final void mNumber() throws RecognitionException {
        try {
            int _type = Number;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:240:3: ( Int ( '.' ( Digit )* )? )
            // src/grammar/TL.g:240:6: Int ( '.' ( Digit )* )?
            {
            mInt(); 
            // src/grammar/TL.g:240:10: ( '.' ( Digit )* )?
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // src/grammar/TL.g:240:11: '.' ( Digit )*
                    {
                    match('.'); 
                    // src/grammar/TL.g:240:15: ( Digit )*
                    loop2:
                    do {
                        int alt2=2;
    ...
    public final void mIdentifier() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:244:3: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | Digit )* )
            // src/grammar/TL.g:244:6: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | Digit )*
            {
            ...
            // src/grammar/TL.g:244:34: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | Digit )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mString() throws RecognitionException {
        try {
            ...
            switch (alt7) {
                case 1 :
                    // src/grammar/TL.g:251:6: '\"' (~ ( '\"' | '\\\\' ) | '\\\\' ( '\\\\' | '\"' ) )* '\"'
                    {
                    match('\"'); 
                    // src/grammar/TL.g:251:11: (~ ( '\"' | '\\\\' ) | '\\\\' ( '\\\\' | '\"' ) )*
                    loop5:
                    do {
                        int alt5=3;
                    ...
                    break;
                case 2 :
                    // src/grammar/TL.g:252:6: '\\'' (~ ( '\\'' | '\\\\' ) | '\\\\' ( '\\\\' | '\\'' ) )* '\\''
                    {
                    match('\''); 
                    // src/grammar/TL.g:252:11: (~ ( '\\'' | '\\\\' ) | '\\\\' ( '\\\\' | '\\'' ) )*
                    loop6:
                    do {
                        int alt6=3;
    ...
    public final void mComment() throws RecognitionException {
        try {
            ...
            switch (alt10) {
                case 1 :
                    // src/grammar/TL.g:256:6: '//' (~ ( '\\r' | '\\n' ) )*
                    {
                    match("//"); 

                    // src/grammar/TL.g:256:11: (~ ( '\\r' | '\\n' ) )*
                    loop8:
                    do {
                        int alt8=2;
                    ...
                    break;
                case 2 :
                    // src/grammar/TL.g:257:6: '/*' ( . )* '*/'
                    {
                    match("/*"); 

                    // src/grammar/TL.g:257:11: ( . )*
                    loop9:
                    do {
                        int alt9=2;
    ...
    public final void mSpace() throws RecognitionException {
        try {
            int _type = Space;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/grammar/TL.g:261:3: ( ( ' ' | '\\t' | '\\r' | '\\n' | '\\u000C' ) )
            // src/grammar/TL.g:261:6: ( ' ' | '\\t' | '\\r' | '\\n' | '\\u000C' )
            {
    ...
    public final void mInt() throws RecognitionException {
        try {
            // src/grammar/TL.g:265:3: ( '1' .. '9' ( Digit )* | '0' )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // src/grammar/TL.g:265:6: '1' .. '9' ( Digit )*
                    {
                    matchRange('1','9'); 
                    // src/grammar/TL.g:265:15: ( Digit )*
                    loop11:
                    do {
                        int alt11=2;
    ...
    public final void mDigit() throws RecognitionException {
        try {
            // src/grammar/TL.g:270:3: ( '0' .. '9' )
            // src/grammar/TL.g:270:6: '0' .. '9'
            {
            matchRange('0','9'); 
