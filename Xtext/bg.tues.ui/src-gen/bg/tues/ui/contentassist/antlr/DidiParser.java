 ...
 * generated by Xtext
 */
package bg.tues.ui.contentassist.antlr;
...
public class DidiParser extends AbstractContentAssistParser {
	...
	@Override
	protected bg.tues.ui.contentassist.antlr.internal.InternalDidiParser createParser() {
		bg.tues.ui.contentassist.antlr.internal.InternalDidiParser result = new bg.tues.ui.contentassist.antlr.internal.InternalDidiParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConditionStatementAccess().getAlternatives_1_0(), "rule__ConditionStatement__Alternatives_1_0");
					...
					put(grammarAccess.getIfFragmentAccess().getGroup(), "rule__IfFragment__Group__0");
					put(grammarAccess.getElseIfFragmentAccess().getGroup(), "rule__ElseIfFragment__Group__0");
					put(grammarAccess.getElseFragmentAccess().getGroup(), "rule__ElseFragment__Group__0");
					...
					put(grammarAccess.getDidiModelAccess().getElementsAssignment(), "rule__DidiModel__ElementsAssignment");
					...
					put(grammarAccess.getVariableCallAccess().getCalledVariableNameAssignment_1(), "rule__VariableCall__CalledVariableNameAssignment_1");
					...
					put(grammarAccess.getIfStatementAccess().getConditionsAssignment_1(), "rule__IfStatement__ConditionsAssignment_1");
					put(grammarAccess.getIfStatementAccess().getConditionsAssignment_2(), "rule__IfStatement__ConditionsAssignment_2");
					put(grammarAccess.getIfStatementAccess().getConditionsAssignment_3(), "rule__IfStatement__ConditionsAssignment_3");
					put(grammarAccess.getIfFragmentAccess().getConditionAssignment_2(), "rule__IfFragment__ConditionAssignment_2");
					put(grammarAccess.getIfFragmentAccess().getIfStatementsAssignment_5(), "rule__IfFragment__IfStatementsAssignment_5");
					put(grammarAccess.getElseIfFragmentAccess().getConditionAssignment_2(), "rule__ElseIfFragment__ConditionAssignment_2");
					put(grammarAccess.getElseIfFragmentAccess().getElseIfStatementsAssignment_5(), "rule__ElseIfFragment__ElseIfStatementsAssignment_5");
					put(grammarAccess.getElseFragmentAccess().getElseStatementsAssignment_3(), "rule__ElseFragment__ElseStatementsAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			bg.tues.ui.contentassist.antlr.internal.InternalDidiParser typedParser = (bg.tues.ui.contentassist.antlr.internal.InternalDidiParser) parser;
			typedParser.entryRuleDidiModel();
