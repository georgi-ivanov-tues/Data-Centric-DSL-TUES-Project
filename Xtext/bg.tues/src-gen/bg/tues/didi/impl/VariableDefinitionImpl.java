 ...
 * <ul>
 *   <li>{@link bg.tues.didi.impl.VariableDefinitionImpl#isIsGlobal <em>Is Global</em>}</li>
 *   <li>{@link bg.tues.didi.impl.VariableDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link bg.tues.didi.impl.VariableDefinitionImpl#getVariableValue <em>Variable Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableDefinitionImpl extends SimpleStatementImpl implements VariableDefinition
{
  ...
  {
    return DidiPackage.Literals.VARIABLE_DEFINITION;
  }
  ...
  public void setIsGlobal(boolean newIsGlobal)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DidiPackage.VARIABLE_DEFINITION__IS_GLOBAL, oldIsGlobal, isGlobal));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DidiPackage.VARIABLE_DEFINITION__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetVariableValue(VariableValue newVariableValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DidiPackage.VARIABLE_DEFINITION__VARIABLE_VALUE, oldVariableValue, newVariableValue);
  ...
  public void setVariableValue(VariableValue newVariableValue)
  {
    if (newVariableValue != variableValue)
    {
      ...
      if (variableValue != null)
        msgs = ((InternalEObject)variableValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DidiPackage.VARIABLE_DEFINITION__VARIABLE_VALUE, null, msgs);
      if (newVariableValue != null)
        msgs = ((InternalEObject)newVariableValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DidiPackage.VARIABLE_DEFINITION__VARIABLE_VALUE, null, msgs);
      msgs = basicSetVariableValue(newVariableValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DidiPackage.VARIABLE_DEFINITION__VARIABLE_VALUE, newVariableValue, newVariableValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DidiPackage.VARIABLE_DEFINITION__IS_GLOBAL:
        return isIsGlobal();
      case DidiPackage.VARIABLE_DEFINITION__NAME:
        return getName();
      case DidiPackage.VARIABLE_DEFINITION__VARIABLE_VALUE:
