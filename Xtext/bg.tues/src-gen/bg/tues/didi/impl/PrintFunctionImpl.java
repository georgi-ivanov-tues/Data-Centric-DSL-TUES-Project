 ...
 * <ul>
 *   <li>{@link bg.tues.didi.impl.PrintFunctionImpl#getPrintParam <em>Print Param</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrintFunctionImpl extends SimpleStatementImpl implements PrintFunction
{
  ...
  public NotificationChain basicSetPrintParam(PrintParam newPrintParam, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DidiPackage.PRINT_FUNCTION__PRINT_PARAM, oldPrintParam, newPrintParam);
  ...
  public void setPrintParam(PrintParam newPrintParam)
  {
    if (newPrintParam != printParam)
    {
      ...
      if (printParam != null)
        msgs = ((InternalEObject)printParam).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DidiPackage.PRINT_FUNCTION__PRINT_PARAM, null, msgs);
      if (newPrintParam != null)
        msgs = ((InternalEObject)newPrintParam).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DidiPackage.PRINT_FUNCTION__PRINT_PARAM, null, msgs);
      msgs = basicSetPrintParam(newPrintParam, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DidiPackage.PRINT_FUNCTION__PRINT_PARAM, newPrintParam, newPrintParam));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DidiPackage.PRINT_FUNCTION__PRINT_PARAM:
