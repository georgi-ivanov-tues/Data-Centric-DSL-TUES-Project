...
((
    ...
    |
    { 
        newCompositeNode(grammarAccess.getSimpleStatementAccess().getPostfixOperationParserRuleCall_0_3()); 
    }
    ...
    |
    { 
        newCompositeNode(grammarAccess.getSimpleStatementAccess().getFunctionCallParserRuleCall_0_4()); 
    }
