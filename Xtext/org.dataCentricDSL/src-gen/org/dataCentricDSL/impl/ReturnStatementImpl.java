 ...
 * <ul>
 *   <li>{@link org.dataCentricDSL.impl.ReturnStatementImpl#getReturnValue <em>Return Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReturnStatementImpl extends SimpleStatementImpl implements ReturnStatement
{
  ...
  {
    return DataCentricDSLPackage.Literals.RETURN_STATEMENT;
  }
  ...
  public NotificationChain basicSetReturnValue(ConditionStatement newReturnValue, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataCentricDSLPackage.RETURN_STATEMENT__RETURN_VALUE, oldReturnValue, newReturnValue);
  ...
  public void setReturnValue(ConditionStatement newReturnValue)
  {
    if (newReturnValue != returnValue)
    {
      ...
      if (returnValue != null)
        msgs = ((InternalEObject)returnValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DataCentricDSLPackage.RETURN_STATEMENT__RETURN_VALUE, null, msgs);
      if (newReturnValue != null)
        msgs = ((InternalEObject)newReturnValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DataCentricDSLPackage.RETURN_STATEMENT__RETURN_VALUE, null, msgs);
      msgs = basicSetReturnValue(newReturnValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DataCentricDSLPackage.RETURN_STATEMENT__RETURN_VALUE, newReturnValue, newReturnValue));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DataCentricDSLPackage.RETURN_STATEMENT__RETURN_VALUE:
