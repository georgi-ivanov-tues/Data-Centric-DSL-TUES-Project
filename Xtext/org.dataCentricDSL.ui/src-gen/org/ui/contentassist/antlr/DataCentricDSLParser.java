...
public class DataCentricDSLParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.ui.contentassist.antlr.internal.InternalDataCentricDSLParser createParser() {
		org.ui.contentassist.antlr.internal.InternalDataCentricDSLParser result = new org.ui.contentassist.antlr.internal.InternalDataCentricDSLParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVariableDeclAccess().getVariableValueAlternatives_3_0(), "rule__VariableDecl__VariableValueAlternatives_3_0");
					...
					put(grammarAccess.getPrintAccess().getAlternatives_0(), "rule__Print__Alternatives_0");
					put(grammarAccess.getPrintParamAccess().getAlternatives(), "rule__PrintParam__Alternatives");
					put(grammarAccess.getFunctionCallAccess().getArgumentsAlternatives_2_0_0(), "rule__FunctionCall__ArgumentsAlternatives_2_0_0");
					put(grammarAccess.getFunctionCallAccess().getArgumentsAlternatives_2_1_1_0(), "rule__FunctionCall__ArgumentsAlternatives_2_1_1_0");
					put(grammarAccess.getPrimaryAccess().getAlternatives(), "rule__Primary__Alternatives");
					put(grammarAccess.getCompoundStatementAccess().getAlternatives(), "rule__CompoundStatement__Alternatives");
					put(grammarAccess.getForStatementAccess().getOperationAlternatives_7_0(), "rule__ForStatement__OperationAlternatives_7_0");
					put(grammarAccess.getStatementConditionAccess().getAlternatives_1_0(), "rule__StatementCondition__Alternatives_1_0");
					...
					put(grammarAccess.getBolleanValueAccess().getAlternatives(), "rule__BolleanValue__Alternatives");
					...
					put(grammarAccess.getFunctionDeclAccess().getGroup_3_1(), "rule__FunctionDecl__Group_3_1__0");
					...
					put(grammarAccess.getSwitchStatementAccess().getGroup_7(), "rule__SwitchStatement__Group_7__0");
					...
					put(grammarAccess.getStatementConditionAccess().getGroup(), "rule__StatementCondition__Group__0");
					...
					put(grammarAccess.getVariableParamAccess().getVariableBolleanValueAssignment_1_3(), "rule__VariableParam__VariableBolleanValueAssignment_1_3");
					...
					put(grammarAccess.getFunctionDeclAccess().getNameAssignment_1(), "rule__FunctionDecl__NameAssignment_1");
					put(grammarAccess.getFunctionDeclAccess().getArgumentsAssignment_3_0(), "rule__FunctionDecl__ArgumentsAssignment_3_0");
					put(grammarAccess.getFunctionDeclAccess().getArgumentsAssignment_3_1_1(), "rule__FunctionDecl__ArgumentsAssignment_3_1_1");
					put(grammarAccess.getFunctionDeclAccess().getStatementsAssignment_6(), "rule__FunctionDecl__StatementsAssignment_6");
					...
					put(grammarAccess.getIfStatementAccess().getStatementsAssignment_8_5(), "rule__IfStatement__StatementsAssignment_8_5");
					put(grammarAccess.getIfStatementAccess().getStatementsAssignment_9_2(), "rule__IfStatement__StatementsAssignment_9_2");
					put(grammarAccess.getSwitchStatementAccess().getNameAssignment_3(), "rule__SwitchStatement__NameAssignment_3");
					put(grammarAccess.getSwitchStatementAccess().getCasesAssignment_6_1(), "rule__SwitchStatement__CasesAssignment_6_1");
					put(grammarAccess.getSwitchStatementAccess().getStatementsAssignment_6_3(), "rule__SwitchStatement__StatementsAssignment_6_3");
					put(grammarAccess.getSwitchStatementAccess().getStatementsAssignment_7_2(), "rule__SwitchStatement__StatementsAssignment_7_2");
					put(grammarAccess.getWhileStatementAccess().getWhileConditionAssignment_3(), "rule__WhileStatement__WhileConditionAssignment_3");
					put(grammarAccess.getWhileStatementAccess().getStatementsAssignment_6(), "rule__WhileStatement__StatementsAssignment_6");
					put(grammarAccess.getForStatementAccess().getForVarAssignment_3(), "rule__ForStatement__ForVarAssignment_3");
					put(grammarAccess.getForStatementAccess().getForConditionAssignment_5(), "rule__ForStatement__ForConditionAssignment_5");
					put(grammarAccess.getForStatementAccess().getOperationAssignment_7(), "rule__ForStatement__OperationAssignment_7");
					put(grammarAccess.getForStatementAccess().getStatementsAssignment_10(), "rule__ForStatement__StatementsAssignment_10");
					put(grammarAccess.getStatementConditionAccess().getStatementConditionAssignment_0(), "rule__StatementCondition__StatementConditionAssignment_0");
					put(grammarAccess.getStatementConditionAccess().getStatementConditionAssignment_1_1(), "rule__StatementCondition__StatementConditionAssignment_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.ui.contentassist.antlr.internal.InternalDataCentricDSLParser typedParser = (org.ui.contentassist.antlr.internal.InternalDataCentricDSLParser) parser;
			typedParser.entryRuleDataCentricDSL();
