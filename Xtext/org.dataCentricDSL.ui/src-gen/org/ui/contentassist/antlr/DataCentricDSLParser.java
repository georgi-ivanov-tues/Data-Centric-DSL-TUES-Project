		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getIfStatementAccess().getIfElementsAssignment_4(), "rule__IfStatement__IfElementsAssignment_4");
					put(grammarAccess.getIfStatementAccess().getConditionAssignment_6_1(), "rule__IfStatement__ConditionAssignment_6_1");
					put(grammarAccess.getIfStatementAccess().getIfElementsAssignment_6_3(), "rule__IfStatement__IfElementsAssignment_6_3");
					put(grammarAccess.getIfStatementAccess().getIfElementsAssignment_7_2(), "rule__IfStatement__IfElementsAssignment_7_2");
					...
					put(grammarAccess.getSwitchStatementAccess().getSwitchElementsAssignment_6_3(), "rule__SwitchStatement__SwitchElementsAssignment_6_3");
					put(grammarAccess.getSwitchStatementAccess().getSwitchElementsAssignment_7_2(), "rule__SwitchStatement__SwitchElementsAssignment_7_2");
					put(grammarAccess.getConditionAccess().getExpressionsAssignment_1(), "rule__Condition__ExpressionsAssignment_1");
					put(grammarAccess.getConditionAccess().getOpAssignment_2_0(), "rule__Condition__OpAssignment_2_0");
					put(grammarAccess.getConditionAccess().getExpressionsAssignment_2_1(), "rule__Condition__ExpressionsAssignment_2_1");
